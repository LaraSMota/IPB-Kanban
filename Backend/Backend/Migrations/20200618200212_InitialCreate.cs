        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    title = table.Column<string>(type: "nvarchar(100)", unicode: false, maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    users_id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    firstName = table.Column<string>(type: "nvarchar(100)", unicode: false, maxLength: 100, nullable: false),
                    lastName = table.Column<string>(type: "nvarchar(100)", unicode: false, maxLength: 200, nullable: false),
                    email = table.Column<string>(type: "nvarchar(100)", unicode: false, maxLength: 200, nullable: false),
                    nickname = table.Column<string>(type: "nvarchar(100)", unicode: false, maxLength: 100, nullable: false),
                    password = table.Column<string>(type: "nvarchar(100)", unicode: false, maxLength: 100, nullable: false),
                    picture = table.Column<string>(type: "nvarchar(500)", unicode: false, maxLength: 500, nullable: true),
                    beNotified = table.Column<string>(type: "nvarchar(100)", unicode: false, maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    board_id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    title = table.Column<string>(type: "nvarchar(100)", unicode: false, maxLength: 200, nullable: false),
                    description = table.Column<string>(type: "nvarchar(1000)", unicode: false, maxLength: 500, nullable: true),
                    background = table.Column<string>(type: "nvarchar(100)", unicode: false, maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    member_id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    permitionLevel = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    collumn_id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    title = table.Column<string>(type: "nvarchar(100)", unicode: false, maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    attachments = table.Column<string>(type: "nvarchar(100)", unicode: false, maxLength: 500, nullable: true),
                    lables = table.Column<string>(type: "nvarchar(100)", unicode: false, maxLength: 200, nullable: true),
                    dueDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    description = table.Column<string>(type: "nvarchar(1000)", unicode: false, maxLength: 500, nullable: true),
                    checklist = table.Column<string>(type: "nvarchar(100)", unicode: false, maxLength: 500, nullable: true),
                    collumn_id = table.Column<int>(type: "int", nullable: true),
                    position = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
